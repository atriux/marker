...
class EnqueueAssets{
	...
	public function adding_scripts(){
		...
		wp_enqueue_script("post-highlighter-js", POST_HIGHLIGHTER_URL . "assets/js/post-highlighter.js" , array('jquery'),time(), true);
		wp_localize_script( "post-highlighter-js", 'post_highlighter', $js_data );
